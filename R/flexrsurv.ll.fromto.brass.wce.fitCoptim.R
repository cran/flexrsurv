flexrsurv.ll.fromto.brass0.wce.fitCoptim<-function (Y, X0, X, Z, W,
		BX0, 
		Id, FirstId,  
		expected_rate, 
		expected_logit_end, 
...
#    opgFunction    <- NULL
		...
		stop("flexrsurv.ll.fromto.brass0.wce.fitCoptim(): bhlink = 'identity' not implemented for WCE effect")
