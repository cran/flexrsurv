ll_flexrsurv_gamma0<-function(gamma0, alpha0, beta0, alpha, beta, Y, X0, X, Z, 
                            ...
                            Spline_t0=BSplineBasis(knots=NULL,  degree=3,   keep.duplicates=TRUE),
                              Intercept_t0=FALSE,
                            nT0basis,
                            nX0,
                            nX, 
...
YT0Gamma0 <- predictSpline(Spline_t0*tmpgamma0, Y[,1], intercept=Intercept_t0)
  ...
  if(nX + nZ) {
    NPHterm <- intTD(func=rateTD_gamma0alphabeta, intTo=Y[,1], intToStatus=Y[,2],
    ...
    NPHterm <- intTD(func=rateTD_gamma0, intTo=Y[,1], intToStatus=Y[,2],
                     step=step, Nstep=Nstep,
                     intweightsfunc=intweightsfunc, 
                     gamma0=gamma0,
                     Spline_t0=Spline_t0*tmpgamma0, Intercept_t0=Intercept_t0,
