gr_cumhaz_flexrsurv_GA0B0AB<-function(GA0B0AB, var,
                                      Y, X0, X, Z, 
                                      step, Nstep, 
...
if (debug) cat("# computing gradient of the cumulative hazard: gr_cumhaz_flexrsurv_GA0B0AB\n")
