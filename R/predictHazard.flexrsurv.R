...
# get coefficients in order baseline hazard | linear & non-linear effects | non Prop efefct | nonlin_nonprop effects 
    ...
    if ( type != "terms" ){
      linpred <- .computeLinearPredictor_GA0B0AB(GA0B0AB=alltheparameters,
                                                          Y=Y, X0=X0, X=X, Z=Z,
                                                          nT0basis=nT0basis,
                                                          ...
                                                          debug=10000)    
      if (se.fit) {
        stderr <- .computeStdErrorLinearPredictor_GA0B0AB(GA0B0AB=alltheparameters,
                                                                            var=object$var,
                                                                            Y=Y, X0=X0, X=X, Z=Z,
                                                                            nT0basis=nT0basis,
                                                                            Spline_t0=Spline_t0, Intercept_t0=Intercept_t0,
...
#      linearPredictors <- .computeTermsLinearPredictor_GA0B0AB(GA0B0AB=alltheparameters,
#                                                                            var=object$var,
#                                                               Y=Y, X0=X0, X=X, Z=Z,
#                                                               nT0basis=nT0basis,
#                                                               Spline_t0=Spline_t0, Intercept_t0=Intercept_t0,
...
#      
#      if (!se.fit) {
#        stdErrorLinearPredictors <- .computeStdErrorTermsLinearPredictor_GA0B0AB(GA0B0AB=alltheparameters,
#                                                                                 Y=Y, X0=X0, X=X, Z=Z,
#                                                                                 nT0basis=nT0basis,
#                                                                                 Spline_t0=Spline_t0, Intercept_t0=Intercept_t0,
#                                                                                 ialpha0=ialpha0, nX0=nX0,
