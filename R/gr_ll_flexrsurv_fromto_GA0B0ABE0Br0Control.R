gr_ll_flexrsurv_fromto_GA0B0ABE0Br0Control<-function(allparam,
		Y, X0, X, Z, W,
		BX0,
...
#      print("length(Y1C)")
#      print(length(Y1C))
#      print("length(expected_logit_entercontrol)")
#      print(length(expected_logit_entercontrol))
#      print("length(BPHtermcontrol)")
#      print(length(BPHtermcontrol))
#      print("summary(Y1C)")
#      print(summary(Y1C))
#      print("summary(expected_logit_entercontrol)")
#      print(summary(expected_logit_entercontrol))
#      print("length(predictSpline(S_B, expected_logit_entercontrol))")
#      print(length(predictSpline(S_B, expected_logit_entercontrol)))
#      print("summary(predictSpline(S_B, expected_logit_entercontrol))")
#      print(summary(predictSpline(S_B, expected_logit_entercontrol)))
#      print("**************************************************grad, end control")
#      print("summary(Y2C)")
#      print(summary(Y2C))
#      print("summary(expected_logit_endcontrol)")
#      print(summary(expected_logit_endcontrol))
#      print("summary(E1C)")
#      print(summary(E1C))
#      print("summary(E2C)")
...
#      print("summary(DE2C)")
#      print(summary(DE2C))
#      print("summary(evalderivbrasscontrol)")
#      print(summary(evalderivbrasscontrol))
#      print("S_B")
#      print(S_B)
#      print("**************************************************grad, fin control")
			if (!is.null(weightscontrol)) {
# code equivalent to the one of the periode approach 
...
#					crossprod(E2C, ( Y2C   * BPHtermcontrol)* weightscontrol /(1+ Y2C) ) 
# faster
				dLdbrass0 <- crossprod(DE2C, Ycontrol[,3]*weightscontrol/evalderivbrasscontrol) +
...
#					crossprod(E2C, ( Y2C   * BPHtermcontrol)/(1+ Y2C) ) 
...
#					crossprod(E2E, ( Y2E   * BPHterm)* weights /(1+ Y2E) ) 
# faster
			dLdbrass0 <- crossprod(DE2E , Ftable *weights/evalderivbrass) +
...
#					crossprod(E2E, ( Y2E   * BPHterm)/(1+ Y2E) )
	...
	if( nBX0){
		...
		if (!is.null(weights)) {
			dLdbalpha0 <-  crossprod(BX0 , Ftable* weights ) - 
					crossprod(BX0 ,modified_cumrate  * weights )
# faster	   
#	   dLdbalpha0 <-  crossprod(BX0 ,(Ftable - modified_cumrate ) * weights )
			
		} else {
			dLdbalpha0 <-  crossprod(BX0 , Ftable) - crossprod(BX0 ,modified_cumrate )
# faster	   
...
#  traiter les Intercept_t_NPH
		...
		if(nW){
			dLdeta0 <- NULL
			for(i in 1:nW){
				dLdeta0 <- c(dLdeta0,  crossprod(weights, W[,i] * WF[[i]] - IntbW[[i]]))
			}
